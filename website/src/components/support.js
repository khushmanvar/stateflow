    ...
    <>
      <div className="flex">
        <div className="w-1/3 border-r border-gray-200 pr-8 dark:border-gray-800">
          ...
          <div className="mt-4 flex flex-col gap-4">
            <Button
              to="https://egghead.io/courses/manage-application-state-with-stateflow-atoms-2c3a29f0"
              className="w-full dark:!bg-gray-950 dark:hover:!bg-teal-950"
              bold
              external
            >
              Manage Application State with Stateflow Atoms
            ...
            <Button
              to="https://daishi.gumroad.com/l/learn-stateflow/website_qpiwdj8"
              className="w-full dark:!bg-gray-950 dark:hover:!bg-teal-950"
              bold
              external
            >
              Learn Simplified Stateflow
            </Button>
            <Button
              to="https://daishi.gumroad.com/l/philosophy-of-stateflow-1"
              className="w-full dark:!bg-gray-950 dark:hover:!bg-teal-950"
              bold
              external
            >
              Philosophy of Stateflow: Part 1
            </Button>
          </div>
        </div>
      ...
      <div>
        <div className="mt-8 flex items-center gap-6">
          ...
          >
            <img
              src="https://cdn.candycode.com/stateflow/daishi.png"
