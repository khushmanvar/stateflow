import { useSetAtom } from 'stateflow';
    ...
    <aside className="scrollbar sticky top-0 hidden h-full max-h-screen min-h-full w-full flex-shrink-0 flex-col justify-between overflow-y-scroll overscroll-none p-8 lg:flex lg:max-w-[288px] xl:max-w-[384px] xl:p-16 2xl:max-w-[448px]">
      <div className="flex-grow">
        ...
        <div className="mt-8 flex flex-col space-y-4">
          ...
          <Button icon="chalkboard" to="https://tutorial.stateflow.org" external>
            Tutorial
          </Button>
          <Button icon="help" onClick={() => setShowHelp(true)}>
            Support
          </Button>
          <Button icon="github" to="https://github.com/pmndrs/stateflow" external>
            Repository
          </Button>
          <Button icon="npm" to="https://www.npmjs.com/package/stateflow" external>
            Package
          </Button>
          <Button icon="discord" to="https://discord.gg/poimandres" external>
            Community
          </Button>
          <Button icon="twitter" to="https://twitter.com/stateflowjs" external>
            Updates
          </Button>
        </div>
      </div>
