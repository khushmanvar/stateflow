  ...
  return (
    <div className="mx-auto grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-6 2xl:-mx-6">
      <Logo to="https://about.meta.com/">
        <img
          src="https://cdn.candycode.com/stateflow/logos/meta-current.svg"
          alt=""
          className="w-full opacity-50 transition duration-300 ease-in-out dark:invert"
        />
        <HoverLogo>
          <img
            src="https://cdn.candycode.com/stateflow/logos/meta-color.svg"
            alt=""
            className="w-full"
            aria-hidden
          />
      ...
      <Logo to="https://candycode.com/">
        <img
          src="https://cdn.candycode.com/stateflow/logos/candycode-current.svg"
        ...
        <HoverLogo>
          <img
            src="https://cdn.candycode.com/stateflow/logos/candycode-color.svg"
            alt=""
      ...
      <Logo to="https://www.adobe.com/">
        <img
          src="https://cdn.candycode.com/stateflow/logos/adobe-current.svg"
          alt="Adobe"
          className="w-full px-1 opacity-50 transition duration-300 ease-in-out dark:invert lg:px-2"
        />
        <HoverLogo>
          <img
            src="https://cdn.candycode.com/stateflow/logos/adobe-color.svg"
            alt=""
      ...
      <Logo to="https://ping.gg">
        <img
          src="https://cdn.candycode.com/stateflow/logos/ping-current.svg"
          alt="Ping Labs"
          className="aspect-[24/9] w-full opacity-50 transition duration-300 ease-in-out dark:invert"
        />
        <HoverLogo>
          <img
            src="https://cdn.candycode.com/stateflow/logos/ping-color.svg"
            alt=""
      ...
      <Logo to="https://www.tiktok.com/">
        <img
          src="https://cdn.candycode.com/stateflow/logos/tiktok-current.svg"
          alt="TokTok"
          className="w-full px-1 opacity-50 transition duration-300 ease-in-out dark:invert lg:px-2"
        />
        <HoverLogo>
          <img
            src="https://cdn.candycode.com/stateflow/logos/tiktok-color.svg"
            alt=""
            className="w-full px-1 lg:px-2"
            aria-hidden
          />
      ...
      <Logo to="https://uniswap.org/">
        <img
          src="https://cdn.candycode.com/stateflow/logos/uniswap-current.svg"
          alt="Uniswap"
          className="aspect-[16/9] w-full opacity-50 transition duration-300 ease-in-out dark:invert"
        />
        <HoverLogo>
          <img
            src="https://cdn.candycode.com/stateflow/logos/uniswap-color.svg"
            alt=""
            className="aspect-[16/9] w-full"
            aria-hidden
          />
