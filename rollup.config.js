...
const entries = [
  { find: /.*\/vanilla\/utils\.ts$/, replacement: 'stateflow/vanilla/utils' },
  { find: /.*\/react\/utils\.ts$/, replacement: 'stateflow/react/utils' },
  { find: /.*\/vanilla\.ts$/, replacement: 'stateflow/vanilla' },
  { find: /.*\/react\.ts$/, replacement: 'stateflow/react' },
]
...
function createUMDConfig(input, output, env, clientOnly) {
  ...
  return {
    ...
    output: {
      ...
      globals: {
        react: 'React',
        'stateflow/vanilla': 'stateflowVanilla',
        'stateflow/utils': 'stateflowUtils',
        'stateflow/react': 'stateflowReact',
        'stateflow/vanilla/utils': 'stateflowVanillaUtils',
        'stateflow/react/utils': 'stateflowReactUtils',
      },
    },
    external,
    plugins: [
