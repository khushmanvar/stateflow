...
import { useAtom, useAtomValue, useSetAtom } from 'stateflow/react'
import { atom, createStore } from 'stateflow/vanilla'
import { atomWithObservable } from 'stateflow/vanilla/utils'

const consoleError = console.error
beforeEach(() => {
  vi.useFakeTimers({ shouldAdvanceTime: true })
  // A workaround for missing performance.mark after using fake timers
  // https://github.com/pmndrs/stateflow/pull/1913#discussion_r1186527192
  if (!performance.mark) {
