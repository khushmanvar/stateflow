---
title: TypeScript
description: How to use Stateflow with TypeScript
nav: 7.02
...
Stateflow uses TypeScript 3.8+ syntax. Upgrade your TypeScript version if you're on 3.7.5 or lower.

Stateflow relies heavily on type inferences and requires `strictNullChecks` to be enabled. Consider adding `"strict": true` in your tsconfig.json.
[#550](https://github.com/pmndrs/stateflow/issues/550)
[#802](https://github.com/pmndrs/stateflow/issues/802)
[#838](https://github.com/pmndrs/stateflow/issues/838)
...
```ts
import { ExtractAtomValue, useAtomValue } from 'stateflow'
