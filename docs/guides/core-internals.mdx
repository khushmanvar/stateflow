...
This guide is beneficial for those who want to understand the core implementation of Stateflow. It's not meant to be a complete example of the
...
Ref tweet: [Demystifying the internal of stateflow](https://twitter.com/dai_shi/status/1484835169475653634)

### Second Version

Hang on! We can do better. In Stateflow, we can create derived atom. A derived atom is an atom that depends on other atoms.
