...
Stateflow provides primitive functions to optimize re-renders.
...
[stateflow-cache](https://github.com/stateflow-labs/stateflow-cache) is
a third-party library to help such use cases.

### Install

```
npm i stateflow-cache
```
...
import { atomWithCache } from 'stateflow-cache'
