...
```jsx
import { loadable } from "stateflow/utils"
...
Ref: https://github.com/pmndrs/stateflow/pull/341

### Usage

```jsx
import { useAtom } from 'stateflow'
import { atomWithObservable } from 'stateflow/utils'
...
import { unwrap } from 'stateflow/utils'
